...
## How it works
It uses Hydrogen that runs kernel to run R, also can run codes in terminal via the editor of Atom.

## Why "rbox"?

It is a collection of several packages to faciliate working with R, I tried to manage Atoms's packages in a way to
help me to do programming R, also it is very useful for those who use R with other programming languages.
